...
contract('MasterChef', ([alice, bob, carol, dev, minter]) => {
  ...
  describe.skip('Lottery all', async () => {
    ...
    it('real case', async () => {
      ...
      await this.chef.addPool('1000', this.lp1.address, true, { from: minter });
      await this.chef.addPool('1000', this.lp2.address, true, { from: minter });
      await this.chef.addPool('500', this.lp3.address, true, { from: minter });
      await this.chef.addPool('500', this.lp4.address, true, { from: minter });
